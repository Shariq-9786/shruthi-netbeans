...
String query="Insert into records(rollno,name, phoneno,branch_year,email,events) values ('"+rolno+"', '"+nme+"','"+phone+"','"+branch1+"','"+email1+"','MYSTERY ROOMS');";
stmt.execute(query);
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mys.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
