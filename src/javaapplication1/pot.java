 ...
 * @author ehab8
 */
public class pot extends javax.swing.JFrame {

    /**
     * Creates new form pot
     */
    public pot() {
        initComponents();
    }
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addComponent(phon, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(nam)
                                    .addComponent(rol))))
                        .addGap(360, 360, 360))
                    .addGroup(layout.createSequentialGroup()
...
String query="Insert into records(rollno,name, phoneno,branch_year,email,events) values ('"+rolno+"', '"+nme+"','"+phone+"','"+branch1+"','"+email1+"','POTTERY');";
stmt.execute(query);
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
