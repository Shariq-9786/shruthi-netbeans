...
public class tik extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TIKTOK COMPETITION");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        {
            try
            {
                ...
                String query="Insert into records(rollno,name, phoneno,branch_year,email,events) values ('"+rolno+"', '"+nme+"','"+phone+"','"+branch1+"','"+email1+"','TIKTOK COMPETITION');";
                stmt.execute(query);
