...
public class pubg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PUBG TOURNMENT");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        {
            try
            {
                ...
                String query="Insert into records(rollno,name, phoneno,branch_year,email,events) values ('"+rolno+"', '"+nme+"','"+phone+"','"+branch1+"','"+email1+"','PUBG TOURNMENT');";
                stmt.execute(query);
